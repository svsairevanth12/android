...
public class TabManager implements NavigationBarView.OnItemSelectedListener {
    ...
    TabManager(MainActivity mainActivity, BottomNavigationView bottomNav) {
        ...
        bottomNav.setBackgroundColor(ContextCompat.getColor(mainActivity, R.color.tabBarBackground));
        ...
        ColorStateList iconColorStates = new ColorStateList(
                ...
                new int[]{
                        ContextCompat.getColor(mainActivity, R.color.tabBarTextColor),
                        ContextCompat.getColor(mainActivity, R.color.tabBarIndicator)
                });
        ...
        for (int i = 0; i < tabs.length(); i++) {
            ...
            if (i < menuSize) {
                ...
                if (menuItem != null) {
                    ...
                    menuItem.setIcon(new Icon(mainActivity, icon, iconSize, iconColor).getDrawable());
                }
            } else {
                // add new menu item
                menu.add(Menu.NONE, i, Menu.NONE, label)
                        .setIcon(new Icon(mainActivity, icon, iconSize, iconColor).getDrawable());
            }
